...
def format_prompt_fucnc(examples):
    ...
    ea_list = examples['EA_Requirement']
    status_list = examples['Status']
    rfp_list = examples['RFP_Coverage']
    gap_list = examples['Gap_analysis']
...
dataset = load_dataset("csv" , data_files="Dataset/extracted_file_converted.csv")
